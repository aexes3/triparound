  ...
  $.get(airURL).then(response => {
    ...
    $.get(airlineJsonFile).then(results => {
      ...
      $("#flightResultsCard").html("<div class='info'>"
        ...
        + "<br><a href='" + response.data[0].deep_link + "'" 
        + blank + "><button>Purchase</button></a>"
        ...
        + "<br><a href='" + response.data[1].deep_link + "'" 
        + blank + "><button>Purchase</button></a>"
        ...
        + "<br><a href='" + response.data[2].deep_link + "'" 
        + blank + "><button>Purchase</button></a></div>");
    });
  });
